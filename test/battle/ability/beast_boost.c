...
TO_DO_BATTLE_TEST("Beast Boost considers Power Split (Multi)");
TO_DO_BATTLE_TEST("Beast Boost considers Guard Split (Multi)");
TO_DO_BATTLE_TEST("Beast Boost considers Power Trick (Multi)");
TO_DO_BATTLE_TEST("Beast Boost considers Wonder Room (Multi)");
TO_DO_BATTLE_TEST("Beast Boost considers Speed Swap (Multi)");
TO_DO_BATTLE_TEST("Beast Boost doesn't consider stat stages (Multi)");
TO_DO_BATTLE_TEST("Beast Boost doesn't consider held items (Multi)");
TO_DO_BATTLE_TEST("Beast Boost doesn't consider status condition reductions (Multi)");
