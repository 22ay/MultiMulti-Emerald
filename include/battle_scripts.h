...
extern const u8 BattleScript_SignatureStatUp[];
...
extern const u8 BattleScript_FlameBodyHeal[];
extern const u8 BattleScript_StaticHeal[];
extern const u8 BattleScript_DamagingTerrain[];
extern const u8 BattleScript_ExtraMoveActivates[];
...
extern const u8 BattleScript_SignatureRain[];
extern const u8 BattleScript_TraceActivates[];
extern const u8 BattleScript_RainDishActivates[];
extern const u8 BattleScript_SandstreamActivates[];
extern const u8 BattleScript_SignatureSandstorm[];
...
extern const u8 BattleScript_AccursedBodyActivates[];
...
extern const u8 BattleScript_AbilityFog[];
...
extern const u8 BattleScript_SignatureMistyTerrain[];
extern const u8 BattleScript_SignatureGrassyTerrain[];
extern const u8 BattleScript_SignatureElectricTerrain[];
extern const u8 BattleScript_SignaturePsychicTerrain[];
...
extern const u8 BattleScript_RaiseStatOnFaintingTargetHubris[];
...
extern const u8 BattleScript_TargetAbilityStatRaiseRetStamina2[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetBerserk[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetBerserk2[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetAngerPoint[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetAngerPoint2[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetRunAway[];
extern const u8 BattleScript_TargetAbilityStatRaiseRetRunAway2[];
...
extern const u8 BattleScript_DeepCutExtraDamage[];
...
extern const u8 BattleScript_AbilityGravity[];
extern const u8 BattleScript_InverseRoomActivates[];
extern const u8 BattleScript_AbilityInverseRoom[];
extern const u8 BattleScript_SignatureGravity[];
...
extern const u8 BattleScript_SignatureRainbow[];
extern const u8 BattleScript_SignatureSeaOfFire[];
extern const u8 BattleScript_SignatureSwamp[];
extern const u8 BattleScript_SignatureReflect[];
extern const u8 BattleScript_SignatureLightScreen[];
extern const u8 BattleScript_SignatureAuroraVeil[];
extern const u8 BattleScript_AbilityRainbow[];
extern const u8 BattleScript_AbilitySeaOfFire[];
extern const u8 BattleScript_AbilitySwamp[];
extern const u8 BattleScript_AbilityTailwind[];
extern const u8 BattleScript_AbilityReflect[];
extern const u8 BattleScript_AbilityLightScreen[];
...
extern const u8 BattleScript_AbilityTrickRoom[];
...
extern const u8 BattleScript_MoveEffectDeepCut[];
