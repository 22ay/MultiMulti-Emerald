...
enum __attribute__((packed)) Ability
{
    ...
    //custom
    ABILITY_INDOMITABLE = ABILITIES_COUNT_GEN9,
    ABILITY_TWISTED_REALM = 312,
    ABILITY_INVERSION = 313,
    ABILITY_GRAVITATIONAL = 314,
    ABILITY_WIND_STORM = 315,
    ABILITY_MYSTIC_POWER = 316,
    ABILITY_VERSATILE = 317,
    ABILITY_ONSLAUGHT = 318,
    ABILITY_MERRY_RAINBOW = 319,
    ABILITY_SEA_OF_FLAMES = 320,
    ABILITY_SWAMPED = 321,
    ABILITY_EERIE_HAZE = 322,
    ABILITY_AVIAN_PROWESS = 323,
    ABILITY_TECTONIZE = 324,
    ABILITY_SPECTRALIZE = 325,
    ABILITY_INFERNAL_SOUL = 326,
    ABILITY_TIDAL_SOUL = 327,
    ABILITY_NATURE_SOUL = 328,
    ABILITY_THUNDEROUS_SOUL = 329,
    ABILITY_WARRIOR_SOUL = 330,
    ABILITY_EQUILIBRIUM = 331,
    ABILITY_COLOSSUS = 332,
    ABILITY_MOMENTUM = 333,
    ABILITY_RUTHLESS = 334,
    ABILITY_VIOLENT_RUSH = 335,
    ABILITY_PHYSICAL_WALL = 336,
    ABILITY_MAGIC_WALL = 337,
    ABILITY_ARCTIC_WALL = 338,
    ABILITY_HUBRIS = 339,
    ABILITY_HORRIFY = 340,
    ABILITY_STRIKER = 341,
    ABILITY_LAST_STAND = 342,
    ABILITY_ARROGANCE = 343,
    ABILITY_BRUTE_FORCE = 344,
    ABILITY_ARCANA = 345,
    ABILITY_LIQUID_BODY = 346,
    ABILITY_DOWN_RANGE = 347,
    ABILITY_MEGA_SOL = 348,
    ABILITY_MEGA_PLUVIA = 349,
    ABILITY_MEGA_HARENA = 350,
    ABILITY_MEGA_NIX = 351,
    ABILITY_MEGA_CALIGO = 352,
    ABILITY_SLOW_AND_STEADY = 353,
    ABILITY_ATLAS = 354,
    ABILITY_GLITCHED = 355,
    ABILITY_ZEPHYR = 356,
    ABILITY_BLITZ = 357,
    ABILITY_JUGGERNAUT = 358,
    ABILITY_BASTION = 359,
    ABILITY_REDIRECTION = 360,
    ABILITY_CLOSE_QUARTERS = 361,
    ABILITY_IMPULSE = 362,
    ABILITY_TWINKLE_TOES = 363,
    ABILITY_ALL_MIGHT = 364,
    ABILITY_BRAWNY = 365,
    ABILITY_MIND_OVER_MATTER = 366,
    ABILITY_VANTAGE_POINT = 367,
    ABILITY_OUTRANGED = 368,
    ABILITY_MEGA_NATURA = 369,
    ABILITY_MEGA_FULGUR = 370,
    ABILITY_MEGA_NEBULA = 371,
    ABILITY_MEGA_PSYCHICA = 372,
    ABILITY_AQUATIC = 373,
    ABILITY_TERRIC = 374,
    ABILITY_PHANTASMIC = 375,
    ABILITY_UMBRIC = 376,
    ABILITY_METALLIC = 377,
    ABILITY_AFTERSHOCK = 378,
    ABILITY_EPICENTER = 379,
    ABILITY_TOXIC_WASTE = 380,
    ABILITY_DRAGONS_RAGE = 381,
    ABILITY_HYPERNOVA = 382,
    ABILITY_FLOW_STATE = 383,
    ABILITY_PARRY = 384,
    ABILITY_REFRACT = 385,
    ABILITY_EQUIPOISE = 386,
    ABILITY_FIELD_SPECIALIST = 387,
    ABILITY_HEART_BREAKER = 388,
    ABILITY_ACCURSED_BODY = 389,
    ABILITY_SPICY_SPRAY = 390,
    ABILITY_PERMAFROST = 391,
    ABILITY_HIGH_VOLTAGE = 392,
