...
enum StringID
{
    ...
    STRINGID_INVERSEROOMENDS,
    STRINGID_BATTLERADDEDTHETYPE,
    STRINGID_AQUARINGHEAL,
    STRINGID_ELECTRICTERRAINENDS,
    STRINGID_ELECTRICTERRAINDMG,
    ...
    STRINGID_ATTACKERGAINEDSTRENGTHFROMALLIES,
    ...
    STRINGID_TARGETISDEEPLYCUT,
    STRINGID_TARGETISHURTBYSALTCURE,
    STRINGID_TARGETISHURTBYDEEPCUT,
