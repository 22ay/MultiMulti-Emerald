...
#define B_TRAINER_SCALING_LEVEL_VARIATION   0       // Random level reduction (0 to 255)
...
#define B_WILD_SCALING_DEFAULT_MODE         LEVEL_SCALING_TO_LEVEL_CAP
#define B_WILD_SCALING_LEVEL_AUGMENT        -6       // Add/subtract levels from base (-127 to +127)
