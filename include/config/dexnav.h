...
#define DN_FLAG_DEXNAV_GET            FLAG_DEXNAV_START_MENU // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_DEXNAV_DETECTOR // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_DEXNAV_SPECIES // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_DEXNAV_HIDDEN // Steps for finding hidden pokemon
