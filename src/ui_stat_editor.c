...
static void PrintMonStats()
{
    ...
    u16 abilityId = GetAbilityBySpecies(sStatEditorDataPtr->speciesID,GetMonData(ReturnPartyMon(), MON_DATA_ABILITY_NUM));
    StringCopy(gStringVar2, gAbilitiesInfo[abilityId].name);
