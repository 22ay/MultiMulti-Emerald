...
{
    { SPECIES_SMEARGLE,   MOVE_POWER_UP_PUNCH, 0, 0, FALSE,  FALSE,  TRUE, SIG_PWRFORMULA_WATERSPOUT,     SIG_ATKSTAT_NORMAL, SIG_ENV_NONE, SIG_STATBOOST_NONE },
    { SPECIES_SCIZOR,     MOVE_BULLET_PUNCH, 60, 0, FALSE, FALSE, FALSE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_ENV_NONE, SIG_STATBOOST_NONE },
    { SPECIES_TYPHLOSION, MOVE_ERUPTION,     0, 1, FALSE, FALSE, FALSE, SIG_PWRFORMULA_REVERSAL, SIG_ATKSTAT_NORMAL, SIG_ENV_NONE, SIG_STATBOOST_NONE },
    { SPECIES_VENUSAUR,   MOVE_CHLOROBLAST,  0, 0, FALSE, FALSE, FALSE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_ENV_SUN,  SIG_STATBOOST_NONE },
};
