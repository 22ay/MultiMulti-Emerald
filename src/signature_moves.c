...
{
    { SPECIES_SMEARGLE,   MOVE_TACKLE,        0, 0, FALSE, SIG_TYPING_NONE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_EFFECT_ATK_PLUS_1, SIG_MULTI_ALWAYS_2 },
    { SPECIES_SCIZOR,     MOVE_TACKLE, 100, 0, FALSE, SIG_TYPING_RESISTANCE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_EFFECT_NONE, SIG_MULTI_NONE },
    { SPECIES_TYPHLOSION, MOVE_ERUPTION,      0, 1, FALSE, SIG_TYPING_NONE, SIG_PWRFORMULA_REVERSAL,   SIG_ATKSTAT_NORMAL, SIG_EFFECT_NONE, SIG_MULTI_NONE },
