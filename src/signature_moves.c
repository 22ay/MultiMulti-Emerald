...
{
    { SPECIES_SMEARGLE,   MOVE_TACKLE,        0, 0, FALSE, FALSE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_EFFECT_ATK_PLUS_1 },
    { SPECIES_SCIZOR,     MOVE_BULLET_PUNCH, 60, 0, FALSE, FALSE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_EFFECT_NONE },
    { SPECIES_TYPHLOSION, MOVE_ERUPTION,      0, 1, FALSE, FALSE, SIG_PWRFORMULA_REVERSAL,   SIG_ATKSTAT_NORMAL, SIG_EFFECT_NONE },
    { SPECIES_VENUSAUR,   MOVE_CHLOROBLAST,   0, 0, FALSE, FALSE, SIG_PWRFORMULA_NORMAL,     SIG_ATKSTAT_NORMAL, SIG_EFFECT_SUN },
};
