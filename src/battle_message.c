...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNCUTSSPATTACKWITH]                   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} cuts {B_DEF_NAME_WITH_PREFIX2}'s Special Attack!"),
    ...
    [STRINGID_MOVINGSWIFTLY]                        = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is moving swiftly!"),
    [STRINGID_ACCURSEDBODY]                         = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY} cursed {B_ATK_NAME_WITH_PREFIX2}!"),
    ...
    [STRINGID_INVERSEROOMSTART]                     = COMPOUND_STRING("The battlefield became inverted!"),
    ...
    [STRINGID_VITALSPIRITHPGAIN]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX}'s {B_ATK_ABILITY} healed it!"),
    ...
    [STRINGID_BATTLERADDEDTHETYPE]                  = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} added the {B_BUFF2}-type!"),
    ...
    [STRINGID_ZEPHYRWINDPOWER]                      = COMPOUND_STRING("Being hit by Tailwind charged {B_SCR_NAME_WITH_PREFIX2} with power!"),
    ...
    [STRINGID_ATTACKERGAINEDSTRENGTHFROMALLIES]     = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} gained strength from its allies!"),
    ...
    [STRINGID_TARGETISDEEPLYCUT]                    = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is cut deeply!"),
    [STRINGID_TARGETISHURTBYSALTCURE]               = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by {B_BUFF1}!"),
    [STRINGID_TARGETISHURTBYDEEPCUT]                = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is hurt by deep cut!"),
