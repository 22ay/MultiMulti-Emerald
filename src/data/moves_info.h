...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_CUT] =
    {
        ...
        .fieldMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEEP_CUT,
            .chance = 100,
        }),
    ...
    [MOVE_SURF] =
    {
        ...
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 50 : 95,
        .type = TYPE_WATER,
        .accuracy = 100,
        .pp = 15,
    ...
    [MOVE_THUNDER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "cause paralysis."),
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 130 : 120,
        .type = TYPE_ELECTRIC,
        .accuracy = 80,
        .pp = 10,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_HIDDEN_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "vary with the user."),
        #endif
        .power = B_HIDDEN_POWER_DMG >= GEN_6 ? 80 : 1,
    ...
    [MOVE_ROCK_SMASH] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_4 ? 75 : 20,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
        .pp = 15,
        .target = MOVE_TARGET_SELECTED,
    ...
    [MOVE_GUNK_SHOT] =
    {
        ...
        .power = 120,
        .type = TYPE_POISON,
        .accuracy = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 70,
        .pp = 5,
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
