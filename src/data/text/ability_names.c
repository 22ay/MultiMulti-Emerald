...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] = {
    ...
    [ABILITY_COMPOUND_EYES] = _("Compound Eye"),
    ...
    [ABILITY_LIGHTNING_ROD] = _("Lightning Ro"),
    ...
    [ABILITY_PSYCHIC_SURGE] = _("Psychic Surg"),
    ...
    [ABILITY_SCREEN_CLEANER] = _("Screen Clean"),
    [ABILITY_STEELY_SPIRIT] = _("Steely Spiri"),
    [ABILITY_PERISH_BODY] = _("Perish Body"),
    [ABILITY_WANDERING_SPIRIT] = _("Wandering Sp"),
    [ABILITY_GORILLA_TACTICS] = _("Gorilla Tact"),
    [ABILITY_NEUTRALIZING_GAS] = _("Neutralizin"),
    [ABILITY_PASTEL_VEIL] = _("Pastel Veil"),
    [ABILITY_HUNGER_SWITCH] = _("Hunger Swit"),
    [ABILITY_QUICK_DRAW] = _("Quick Draw"),
    [ABILITY_UNSEEN_FIST] = _("Unseen Fist"),
    [ABILITY_CURIOUS_MEDICINE] = _("Curious Medi"),
    [ABILITY_TRANSISTOR] = _("Transistor"),
    [ABILITY_DRAGONS_MAW] = _("Dragon's Maw"),
    [ABILITY_CHILLING_NEIGH] = _("Chilling Nei"),
    [ABILITY_GRIM_NEIGH] = _("Grim Neigh"),
    [ABILITY_AS_ONE_ICE_RIDER] = _("As One"),
    [ABILITY_AS_ONE_SHADOW_RIDER] = _("As One"),
    [ABILITY_LINGERING_AROMA] = _("Lingering Ar"),
    [ABILITY_SEED_SOWER] = _("Seed Sower"),
    [ABILITY_THERMAL_EXCHANGE] = _("Thermal Exch"),
    [ABILITY_ANGER_SHELL] = _("Anger Shell"),
    [ABILITY_PURIFYING_SALT] = _("Purifying Sa"),
    [ABILITY_WELL_BAKED_BODY] = _("Well-Baked B"),
    [ABILITY_WIND_RIDER] = _("Wind Rider"),
    [ABILITY_GUARD_DOG] = _("Guard Dog"),
    [ABILITY_ROCKY_PAYLOAD] = _("Rocky Payloa"),
    ...
    [ABILITY_VESSEL_OF_RUIN] = _("Vessel of Rui"),
    [ABILITY_SWORD_OF_RUIN] = _("Sword of Rui"),
    [ABILITY_TABLETS_OF_RUIN] = _("Tablets of Ru"),
    [ABILITY_BEADS_OF_RUIN] = _("Beads of Ruin"),
    [ABILITY_ORICHALCUM_PULSE] = _("Orichalcum P"),
    ...
    [ABILITY_SUPREME_OVERLORD] = _("Supreme Overlo"),
    ...
    [ABILITY_MYCELIUM_MIGHT] = _("Mycelium Mig"),
    ...
    [ABILITY_SUPERSWEET_SYRUP] = _("Supersweet Sy"),
    [ABILITY_TERA_SHIFT] = _("Tera Shift"),
    [ABILITY_TERA_SHELL] = _("Tera Shell"),
    [ABILITY_TERAFORM_ZERO] = _("Teraform Zer"),
    [ABILITY_POISON_PUPPETEER] = _("Poison Pupp"),
};
