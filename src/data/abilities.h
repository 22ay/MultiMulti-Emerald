const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SHED_SKIN] =
    {
        ...
        .longDescription = COMPOUND_STRING("Pokémon may cure it's  \n"
    ...
    [ABILITY_SUPER_LUCK] =
    {
        ...
        .longDescription = COMPOUND_STRING("Raises this Pokémon's\n"
    ...
    [ABILITY_BAD_DREAMS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Sleeping opposing Pokémon\n"
    ...
    [ABILITY_FRIEND_GUARD] =
    {
        ...
        .longDescription = COMPOUND_STRING("Allied Pokémon take 25%\n"
    ...
    [ABILITY_MAGICIAN] =
    {
        .name = _("Magician"),
        .description = COMPOUND_STRING("Steals the foe's held item."),
        .longDescription = COMPOUND_STRING("When this Pokémon uses a\n"
    ...
    [ABILITY_SWEET_VEIL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Prevents this Pokémon\n"
    ...
    [ABILITY_DANCER] =
    {
        ...
        .longDescription = COMPOUND_STRING("When another Pokémon uses\n"
                                           "a dance move, this\n"
                                           "Pokémon copies it right\n"
                                           "afterward."),
        .aiRating = 5,
    },
    ...
    [ABILITY_PERISH_BODY] =
    {
        ...
        .longDescription = COMPOUND_STRING("Contact with this Pokémon\n"
    ...
    [ABILITY_NEUTRALIZING_GAS] =
    {
        ...
        .longDescription = COMPOUND_STRING("While this Pokémon is in\n"
    ...
    [ABILITY_TWISTED_REALM] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon creates Trick\n"
                                           "Room for five turns,\n"
                                           "inverting the turn\n"
                                           "order."),
        .aiRating = 7,
    ...
    [ABILITY_INVERSION] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon creates Inverse\n"
                                           "Room for five turns,\n"
                                           "inverting the type\n"
                                           "chart."),
        .aiRating = 7,
    ...
    [ABILITY_GRAVITATIONAL] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon increases Gravity\n"
                                           "for five turns, dropping\n"
                                           "Pokémon from the air and\n"
                                           "increasing accuracy."),
        .aiRating = 6,
    },
    ...
    [ABILITY_WIND_STORM] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon summons Tailwind\n"
                                           "for five turns, increasing\n"
                                           "the speed of Pokémon on\n"
                                           "the same side."),
        .aiRating = 6,
    },
    ...
    [ABILITY_VERSATILE] =
    {
        ...
        .longDescription = COMPOUND_STRING("All of this Pokémon's moves\n"
                                           "get STAB, increasing their\n"
                                           "damage by 50%."),
        .aiRating = 8,
    },
    ...
    [ABILITY_ONSLAUGHT] =
    {
        .name = _("Onslaught"),
        .description = COMPOUND_STRING("Moves hit twice"),
        .longDescription = COMPOUND_STRING("This Pokémon's moves hit\n"
                                           "two times, barring\n"
                                           "multi-hit moves."),
        .aiRating = 10,
    },
    ...
    [ABILITY_MERRY_RAINBOW] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon creates a Rainbow\n"
                                           "on their side, doubling\n"
    ...
    [ABILITY_SEA_OF_FLAMES] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon summons a Sea\n"
                                           "of Fire on the opposing\n"
                                           "side. Non Fire-types\n"
                                           "take 1/8 damage per\n"
                                           "turn."),
        .aiRating = 6,
    ...
    [ABILITY_SWAMPED] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon summons a\n"
                                           "Swamp on the opposing\n"
                                           "side, quartering the\n"
                                           "foe's speed"),
        .aiRating = 6,
    },
    ...
    [ABILITY_EERIE_HAZE] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Pokémon summons a Fog,\n"
                                           "boosting Ghost, Dark and\n"
                                           "Bug damage by 50%, and\n"
                                           "drops accuracy on\n"
                                           "the other types"),
        .aiRating = 6,
    },
    ...
    [ABILITY_AVIAN_PROWESS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Raises Sp.Attack, but locks\n"
                                           "this Pokémon into the\n"
                                           "first move it selects."),
        .aiRating = 4,
    },
    ...
    [ABILITY_INFERNAL_SOUL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Fire-type moves go first\n"
                                           "in the Sun."),
        .aiRating = 6,
    },
    ...
    [ABILITY_TIDAL_SOUL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Water-type moves go first\n"
                                           "in Rain."),
        .aiRating = 6,
    },
    ...
    [ABILITY_NATURE_SOUL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Grass-type moves go first\n"
                                           "in Grassy Terrain."),
        .aiRating = 6,
    },
    ...
    [ABILITY_THUNDEROUS_SOUL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Electric-type moves go first\n"
                                           "in Electric Terrain."),
        .aiRating = 6,
    },
    ...
    [ABILITY_WARRIOR_SOUL] =
    {
        ...
        .longDescription = COMPOUND_STRING("Fighting moves go first."),
        .aiRating = 6,
    },
    ...
    [ABILITY_COLOSSUS] =
    {
        ...
        .longDescription = COMPOUND_STRING("The Defense stat is used\n"
                                           "for Attack calculations\n"
                                           "and Sp.Defense is used\n"
                                           "for Sp.Attack\n"
                                           "calculations."),
        .aiRating = 6,
    },
    ...
    [ABILITY_RUTHLESS] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon deals 30% more\n"
                                           "damage when the foe is at\n"
                                           "less than half HP."),
        .aiRating = 6,
    },
    ...
    [ABILITY_VIOLENT_RUSH] =
    {
        ...
        .longDescription = COMPOUND_STRING("On the first turn, this\n"
                                           "Pokémon's Speed is\n"
                                           "boosted by 50% and\n"
                                           "its Attack by 20%."),
        .aiRating = 6,
    ...
    [ABILITY_PHYSICAL_WALL] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon sets up Reflect\n"
                                           "halving physical attacks for\n"
                                           "5 turns."),
        .aiRating = 6,
    },
    ...
    [ABILITY_MAGIC_WALL] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon sets up Light\n"
                                           "Screen, halving special\n"
                                           "attacks for 5 turns."),
        .aiRating = 6,
    },
    ...
    [ABILITY_ARCTIC_WALL] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon sets up\n"
                                           "Aurora Veil in the Snow,\n"
                                           "halving damage for\n" 
                                           "5 turns."),
        .aiRating = 6,
    },
    ...
    [ABILITY_HUBRIS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Raises Sp.Attack by 1 stage\n"
                                           "each time the Pokémon\n"
                                           "knocks out a foe."),
        .aiRating = 6,
    },
    ...
    [ABILITY_ARROGANCE] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon does double\n"
                                           "damage at full HP."),
        .aiRating = 6,
    },
    ...
    [ABILITY_BRUTE_FORCE] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon's attacks use\n"
                                           "its Attack stat during\n"
                                           "damage calculations.\n"
                                           "Attack also do 20%.\n" 
                                           "more damage."),
        .aiRating = 6,
    ...
    [ABILITY_MEGA_SOL] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon's moves, effects\n"
                                           "and abilities operate as if\n"
                                           "it is under the Sun."),
        .aiRating = 6,
    },
    ...
    [ABILITY_GLITCHED] =
    {
        ...
        .longDescription = COMPOUND_STRING("Type effectiveness is\n"
                                           "reversed for this\n"
                                           "Pokémon."),
        .aiRating = 6,
    },
    ...
    [ABILITY_JUGGERNAUT] =
    {
        ...
        .longDescription = COMPOUND_STRING("50% of this Pokémon's defensive\n"
                                           "stats are added to the\n"
                                           "respective attacking stat\n"
    ...
    [ABILITY_REDIRECTION] =
    {
        ...
        .longDescription = COMPOUND_STRING("50% of the opposing Pokémon's\n"
                                           "attacking stats are added to\n"
                                           "the respective attacking stat\n"
                                           "during damage calculation."),
        .aiRating = 6,
    },
    ...
    [ABILITY_CLOSE_QUARTERS] =
    {
        ...
        .longDescription = COMPOUND_STRING("Contact moves deal double\n"
                                           "damage, but this Pokémon's\n"
                                           "Defense stat is halved."),
        .aiRating = 6,
    },
    ...
    {
        .name = _("Twinkle Toes"),
        .description = COMPOUND_STRING("Some Speed used for Def."),
        .longDescription = COMPOUND_STRING("50% of the Speed stat is\n"
                                           "used for defensive.\n"
                                           "calculations."),
        .aiRating = 6,
    },
    ...
    {
        .name = _("Brawny"),
        .description = COMPOUND_STRING("Some Atk. used for Def."),
    ...
    [ABILITY_OUTRANGED] =
    {
        ...
        .longDescription = COMPOUND_STRING("50% of the Sp.Attack stat is\n"
                                           "used for defensive\n"
                                           "calculations."),
        .aiRating = 6,
    },
    ...
    [ABILITY_AQUATIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon adds Water-type.\n"
                                           "on switch-in. Water-type moves\n"
                                           "deal 50% more damage if the\n"
                                           "Pokémon is already Water-type."),
        .aiRating = 6,
    },
    ...
    [ABILITY_TERRIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon adds Ground-type on\n"
                                           "switch-in. Ground-type moves\n"
                                           "deal 50% more damage if the\n"
                                           "Pokémon is already Ground-type."),
        .aiRating = 6,
    },
    ...
    [ABILITY_PHANTASMIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon adds Ghost-type on\n"
                                           "switch-in. Ghost-type moves\n"
                                           "deal 50% more damage if the\n"
                                           "Pokémon is already Ghost-type."),
        .aiRating = 6,
    },
    ...
    [ABILITY_UMBRIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon adds Dark-type on\n"
                                           "switch-in. Dark-type moves\n"
                                           "deal 50% more damage if the\n"
                                           "Pokémon is already Dark-type."),
        .aiRating = 6,
    },
    ...
    [ABILITY_METALLIC] =
    {
        ...
        .longDescription = COMPOUND_STRING("This Pokémon adds Steel-type on\n"
                                           "switch-in. Steel-type moves\n"
                                           "deal 50% more damage if the\n"
                                           "Pokémon is already Steel-type."),
        .aiRating = 6,
    },
